...
def get_args():
    ...
    parser.add_argument("--log_path", "-p", type=str, default="football_transfer_learning_tensorboard")
    parser.add_argument("--checkpoint_path", "-c", type=str, default="football_football_transfer_learning_checkpoints")
